...
<html>
    ...
    <body>
        ...
        <form action="update_guest.jsp">
            ...
            Description: <textarea id="longAnswer" name="description" rows="5" cols="50" value="<%= guestRecord.description%>"></textarea><br>
        ...
        <br><form action="host_main.jsp" method="POST">
            <input type="hidden" name="hostID" value="<%= guestID%>">
