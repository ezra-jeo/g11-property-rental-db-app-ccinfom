...
public class reservation {
    ...
    public reservation(int guestID, int hostID, int propertyListingID, Date startDate, Date endDate, float pricePerNight) {
    ...
    public reservation(int reservationID, int guestID, int hostID, int propertyListingID, Date startDate, Date endDate, float pricePerNight, float totalPrice) {
    ...
    public static float getPrice(int propertyListingID) {
        ...
        String userDB = "root";
        String passwordDB = "Qryebfnevb_SQL2025";
        ...
        try {
            ...
            PreparedStatement ps = conn.prepareStatement("SELECT pricePerNight FROM propertyListing WHERE propertyID = ?;");
    ...
    public static int checkAvailableForReservation(int propertyListingID, Date startDate, Date endDate) {
        ...
        try {
            ...
            PreparedStatement ps = conn.prepareStatement("SELECT COUNT(reservationID) AS count FROM reservations WHERE propertyID = ? AND NOT (endDate < ? OR startDate > ?);");
            ps.setInt(1, propertyListingID);
    ...
    public static ArrayList<reservation> getReservationHost(int hostID) {
        ...
        try {
            ...
            while (rs.next()) {
                reservationList.add(new reservation(rs.getInt("reservationID"), rs.getInt("guestID"), rs.getInt("hostID"), rs.getInt("propertyListingID"), rs.getDate("startDate"), rs.getDate("endDate"), rs.getFloat("pricePerNight"), rs.getFloat("totalPrice")));
            }
    ...
    public static ArrayList<reservation> getReservationGuestProperty(int guestID, int propertyID) {
        ArrayList<reservation> reservationList = new ArrayList<>();
        ...
        try {
            ...
            PreparedStatement ps = conn.prepareStatement("SELECT * FROM reservation WHERE guestID = ? AND propertyListingID = ?;");
            ps.setInt(1, guestID);
