...
<html>
    ...
    <body>
        ...
        <form method="post" action="addHostRating_process.jsp">
            ...
            <jsp:useBean id="reservation" class="Reservation" scope="session"/>
            Reservation ID:
            <select id="reservationID" name="reservationID" required>
                <%
                    ArrayList<Reservation> reservationList = reservation.reservationList;
                    if (reservationList != null) {
                        for (Reservation reservation : reservationList) {
                %>
                            <option value="<%= reservation.getReservationID() %>">
