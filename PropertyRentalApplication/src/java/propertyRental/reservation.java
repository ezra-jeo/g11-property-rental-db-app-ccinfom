...
public class reservation {
    ...
    public static int checkAvailableForReservation(int propertyListingID, Date startDate, Date endDate) {
        ...
        try {
            ...
            while (rs.next()) {
                reservationRecord = new reservation(rs.getInt("reservationtID"), rs.getInt("guestID"), rs.getInt("hostID"), rs.getInt("propertyListingID"), rs.getDate("startDate"), rs.getDate("endDate"), rs.getFloat("totalPrice"));
            }
